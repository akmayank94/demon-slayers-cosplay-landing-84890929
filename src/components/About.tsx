          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className={`lg:w-1/2 transition-all duration-700 delay-300 ${inView ? 'opacity-100' : 'opacity-0 transform translate-x-[50px]'}`}>
              <div className="flex border-b border-gray-200 mb-6">
                <button 
                  className={`py-3 px-5 font-medium relative ${currentTab === 'story' ? 'text-ds-teal' : 'text-ds-gray hover:text-ds-black'}`}
                ...
                <button 
                  className={`py-3 px-5 font-medium relative ${currentTab === 'cosplay' ? 'text-ds-teal' : 'text-ds-gray hover:text-ds-black'}`}
                ...
                <button 
                  className={`py-3 px-5 font-medium relative ${currentTab === 'awards' ? 'text-ds-teal' : 'text-ds-gray hover:text-ds-black'}`}
              ...
              <div className="space-y-6">
                {currentTab === 'story' && (
                  <div className="animate-fade-in">
                    <p className="text-ds-gray leading-relaxed mb-4">
                    ...
                    <p className="text-ds-gray leading-relaxed">
                ...
                {currentTab === 'cosplay' && (
                  <div className="animate-fade-in">
                    ...
                    <div className="flex items-start space-x-4 mt-6">
                      ...
                      <div>
                        <h4 className="font-medium text-ds-black mb-1">Water Breathing Technique</h4>
                        <p className="text-sm text-ds-gray">Specializing in First Form: Water Surface Slash and Tenth Form: Constant Flux</p>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="animate-fade-in">
                    <ul className="space-y-4">
                      <li className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium text-ds-black">Best Performance Award</h4>
                          <p className="text-sm text-ds-gray">AnimeExpo 2023 - Water Breathing Performance</p>
                        </div>
                      </li>
                      <li className="flex items-start space-x-3">
                        <span className="bg-ds-teal/10 text-ds-teal p-1 rounded-full flex items-center justify-center mt-1">
                        ...
                        <div>
                          <h4 className="font-medium text-ds-black">Champion Cosplayer</h4>
                          <p className="text-sm text-ds-gray">National Cosplay Competition 2022</p>
                        </div>
                      </li>
                      <li className="flex items-start space-x-3">
                        <span className="bg-ds-teal/10 text-ds-teal p-1 rounded-full flex items-center justify-center mt-1">
                        ...
                        <div>
                          <h4 className="font-medium text-ds-black">Most Authentic Costume</h4>
                          <p className="text-sm text-ds-gray">Anime Festival Asia 2021</p>
                        </div>
                      </li>
                      <li className="flex items-start space-x-3">
                        <span className="bg-ds-teal/10 text-ds-teal p-1 rounded-full flex items-center justify-center mt-1">
                        ...
                        <div>
                          <h4 className="font-medium text-ds-black">Guest Performer</h4>
                          <p className="text-sm text-ds-gray">Japan Cultural Festival 2023</p>
                        </div>
                      </li>
                    </ul>
                  </div>
