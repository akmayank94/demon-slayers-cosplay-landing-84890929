      ...
      <div className="container mx-auto px-4">
        <div ref={ref}>
          <div className={`text-center mb-16 transition-all duration-700 ${inView ? 'opacity-100' : 'opacity-0 transform translate-y-10'}`}>
            ...
            <p className="mt-4 text-ds-gray dark:text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            <div className={`glass-card p-8 rounded-xl transition-all duration-700 delay-200 ${inView ? 'opacity-100' : 'opacity-0 transform translate-y-10'}`}>
              {submitSuccess ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-xl font-bold text-ds-black dark:text-white mb-2">Message Sent Successfully!</h3>
                  <p className="text-ds-gray dark:text-gray-300">Thank you for reaching out. I'll get back to you soon.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <label htmlFor="name" className="block text-sm font-medium text-ds-gray dark:text-gray-300 mb-1">
                        Your Name
                      </label>
                      <input
                        type="text"
                        ...
                        required
                        className="w-full px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md focus:ring-2 focus:ring-ds-teal/50 focus:border-ds-teal outline-none transition"
                        placeholder="Enter your name"
                      />
                    </div>
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-ds-gray dark:text-gray-300 mb-1">
                        Email Address
                      </label>
                      <input
                        type="email"
                  ...
                  <div className="mb-6">
                    <label htmlFor="subject" className="block text-sm font-medium text-ds-gray dark:text-gray-300 mb-1">
                      Event Type
                    </label>
                    <select
                      id="subject"
                  ...
                  <div className="mb-6">
                    <label htmlFor="message" className="block text-sm font-medium text-ds-gray dark:text-gray-300 mb-1">
                      Message
                    </label>
                    <textarea
                      id="message"
            ...
            <div className={`mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 transition-all duration-700 delay-300 ${inView ? 'opacity-100' : 'opacity-0 transform translate-y-10'}`}>
              <div className="flex flex-col items-center text-center p-4">
                ...
                <h3 className="text-lg font-medium text-ds-black dark:text-white mb-1">Phone</h3>
                <p className="text-ds-gray dark:text-gray-300">+1 (555) 123-4567</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4">
                ...
                <h3 className="text-lg font-medium text-ds-black dark:text-white mb-1">Email</h3>
                <p className="text-ds-gray dark:text-gray-300">tanjiro@cosplay.example</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4">
                ...
                <h3 className="text-lg font-medium text-ds-black dark:text-white mb-1">Location</h3>
                <p className="text-ds-gray dark:text-gray-300">Available for events worldwide</p>
              </div>
            </div>
          </div>
        </div>
